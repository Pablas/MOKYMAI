    ...
    return (
        <nav className={styles.nav}>
            ...
            <ul className={styles.list + ' ' + styles.list_middle}>
                <li>
                    <NavLink end to='/skelbimai' className={(navData) => navData.isActive ? styles.active_link : ``
                        //UZSIDEDA ANT AKTYVIOS NUORODOS TAS STILIUS!!!
                        //end PRADZIOJ JEIGU DALINASI TUO PAT LINKU -> /skelbimai/...
                    }>
                        Skelbimai
                    </NavLink>
                </li>
            ...
            <ul className={styles.list}>
                <li><NavLink to='/registruotis' className={(navData) => navData.isActive ? styles.active_link : ``}>
                    Registruotis
                </NavLink></li>
                <li><NavLink to='/prisijungti' className={(navData) => navData.isActive ? styles.active_link : ``}>
                    Prisijungti
                </NavLink></li>
            </ul>
        </nav>
